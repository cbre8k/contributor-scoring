...
abstract contract BaseMigrate is BaseDeploy {
        ...
        returns (address proxy)
    {
        ...
        console.log(unicode"Logic 🧩: ".green(), string.concat(_explorerUrl(), "address/", vm.toString(logic)));
        console.log(unicode"Proxy ⚙️ : ".green(), string.concat(_explorerUrl(), "address/", vm.toString(proxy)));
    }
